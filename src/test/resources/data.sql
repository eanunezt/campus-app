...
INSERT INTO roles (id, nombre) VALUES (1, 'ROL_ADMIN');
INSERT INTO roles (id, nombre) VALUES (2, 'ROL_INVITADO');

INSERT INTO usuarios (id, fecRegistro, fecCambio, email, nombre, password, usuario, id_usuario_cambio) VALUES (1, CURRENT_DATE, CURRENT_DATE, 'admin@email.com', 'admin', '$2a$10$aLD.wO7avgKBsTUJU8KaBOnrCfAPfu1u.CCW635xInBUwzTi2Rt8m', 'admin', NULL);
INSERT INTO usuarios (id, fecRegistro, fecCambio, email, nombre, password, usuario, id_usuario_cambio) VALUES (2, CURRENT_DATE, CURRENT_DATE, 'user@email.com', 'user', '$2a$10$ygvZ/KIvMz81tMpOBfbUR.QwjvxiVvkGm786EWh.oPZSTOoME6t.y', 'user', NULL);

INSERT INTO rol_autorizaciones (id_rol, id_autorizacion,fecRegistro, fecCambio,fecInicial,id_usuario_cambio) VALUES (1, 1,CURRENT_DATE,CURRENT_DATE,CURRENT_DATE,1);
INSERT INTO rol_autorizaciones (id_rol, id_autorizacion,fecRegistro, fecCambio,fecInicial,id_usuario_cambio) VALUES (1, 2,CURRENT_DATE,CURRENT_DATE,CURRENT_DATE,1);
INSERT INTO rol_autorizaciones (id_rol, id_autorizacion,fecRegistro, fecCambio,fecInicial,id_usuario_cambio) VALUES (2, 1,CURRENT_DATE,CURRENT_DATE,CURRENT_DATE,1);
